...
# When Types are unknown - NOT RECOMENDED
...
result_alternative: float = double(4)          # Warning
result_alternative_2: FloatOrList = double(4)  # No Warning


####################################################
# 9. Automatic Narrowing
####################################################
...
def map_function(function: Callable[[float], float], elements: List[float]) -> List[float]:
...
####################################################
# 1. TypeVar and Generics
####################################################


####################################################
# 1.1 Unbound and Unconstrained
####################################################
...
test_float = first_typevar_constrained([1.5, 2.5, 3.5])      # No Warning - Infered type is float
test_str = first_typevar_constrained(["1.5", "2.5", "3.5"])  # No Warning - Infered type is str
test_union = first_typevar_constrained([1.5, "2.5"])         # No Warning - Union is incompatible with given constraints


####################################################
# 1.1 Bounded TypeVars
####################################################
...
test_float = first_typevar_bounded([1.5, 2.5, 3.5])      # No Warning - Infered type is float
test_str = first_typevar_bounded(["1.5", "2.5", "3.5"])  # No Warning - Infered type is str
test_union = first_typevar_bounded([1.5, "2.5"])         # No Warning - Union is incompatible with given constraints


####################################################
# 1.1 Covariant vs Contravariant vs Invariant
####################################################
